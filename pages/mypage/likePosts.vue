        ...
        <div class="container">
            ...
            <div class="wrap">
                <div class="m-tabs type03">
                    <nuxt-link to="/mypage/likePosts" class="m-tab active" @click.prevent="">좋아요한 게시글</nuxt-link>
                    <nuxt-link to="/mypage/sharePosts" class="m-tab">공유한 게시글</nuxt-link>
                </div>
